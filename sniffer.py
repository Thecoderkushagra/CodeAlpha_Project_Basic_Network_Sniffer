# This program can only execute on Linux 
# Windows OS dose not support Low-Level network interface command of 'Socket'.
...
def main(): 
    conn = socket.socket(socket.AF_PACKET, socket.SOCK_RAW, socket.ntohs(3)) # Low-Level network interface commands
